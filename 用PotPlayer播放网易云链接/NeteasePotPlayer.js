...
(function () {
    ...
    img.onclick = function () {
        if (window.location.href.search("my") != -1 && window.location.href.search("artist") != -1) {
        } else {
            window.open(protocol + "://" + document.documentURI);
        }
    }
